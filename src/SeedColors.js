const SeedColors = [
  ...
  {
    paletteName: 'Bangla Palette',
    id: 'Bangla-spanish',
    emoji: 'B',
    colors: [
      { name: 'OASIS STREAM', color: '#92e4d3' },
      { name: 'EXODUS FRUIT', color: '#6355df' },
      { name: 'HOT STONE', color: '#a39f96' },
      { name: 'DEEP ORANGE', color: '#f64f1e' },
      { name: 'GEORGIA PEACH', color: '#f46a6b' },
      { name: 'SPICEDBUTTER NUT', color: '#f7d272' },
      { name: 'Blue', color: '#1e8feb' },
      { name: 'SASQUATCH SOCKS', color: '#f33c74' },
      { name: 'LAVENDER ROSE', color: '#f59fd7' },
      { name: 'Flourescent Red', color: '#ff5252' },
      { name: 'CLOUDS', color: '#e4e8e9' },
      { name: 'FLOURESCENT RED', color: '#eb3d30' },
      { name: 'Red', color: '#ffb142' },
      { name: 'CONCRETE', color: '#8e9e9f' },
      { name: 'ORANGE Yellow', color: '#f69100' },
      { name: 'DEVIL BLUE', color: '#1e698c' },
      { name: 'MAZARINE BLUE', color: '#22366e' },
      { name: 'WET ASPHALT', color: '#2e4357' },
      { name: 'AMERICAN RIVER', color: '#5c676b' },
      { name: 'LIGHT GREENISH BLUE', color: '#4ee7bc' },
    ],
  },
  {
    paletteName: 'Midtone Palette',
    id: 'Midtone-swedish',
    emoji: 'm',
    colors: [
      { name: 'EXODUS FRUIT', color: '#6066d8' },
      { name: 'CARROT', color: '#dd771e' },
      { name: 'PERIWINKLE', color: '#9481f7' },
      { name: 'BLUE BELL', color: '#353591' },
      { name: 'CITY LIGHTS', color: '#d7dee1' },
      { name: 'GREY', color: '#979797' },
      { name: 'GOODSAMARITAN', color: '#365c7b' },
      { name: 'QUINCE JELLY', color: '#e78c27' },
      { name: 'VERRY BERRY', color: '#ad2f6a' },
      { name: 'WHITE PEPPER', color: '#f0e7b2' },
      { name: 'SILVER', color: '#b5bbbf' },
      { name: 'LIGHT GREENISH BLUE', color: '#4ee7bc' },
      { name: 'PINK GLAMOUR', color: '#f67172' },
      { name: 'LAVENDER TEA', color: '#d178f2' },
      { name: 'MERCHANT MARINE BLUE', color: '#064cd5' },
      { name: 'FIERY FUCHSIA', color: '#ab326a' },
      { name: 'YUEGUANG BLUE', color: '#1b3191' },
      { name: 'BLUE MARTINA', color: '#10c3bc' },
      { name: 'BRIGHT UBE', color: '#ce9be0' },
      { name: 'ALIZARIN', color: '#de4536' },
    ],
  },
  {
    paletteName: 'Light Swatch',
    id: 'Light-Swatch',
    emoji: 'Ls',
    colors: [
      { name: 'SOUR LEMON', color: '#f7e29f' },
      { name: 'Pink', color: '#e01b5c' },
      { name: 'JUNE BUD', color: '#b2d450' },
      { name: 'LAVENDER ROSE', color: '#f59fd7' },
      { name: 'BLUE GREY', color: '#597684' },
      { name: 'EXODUS FRUIT', color: '#6066d8' },
      { name: 'PINE GLADE', color: '#b5bd7a' },
      { name: 'WISTERIA', color: '#863da5' },
      { name: 'LIGHT GREEN', color: '#83bb43' },
      { name: 'ASBESTOS', color: '#788586' },
      { name: 'WFORGOTTEN PURPLE', color: '#9179f2' },
      { name: 'LIGHT GREENISH BLUE', color: '#4ee7bc' },
      { name: 'FIRST DATE', color: '#f2a999' },
      { name: 'CARMINE PINK', color: '#e24645' },
      { name: 'NANOHANACHA GOLD', color: '#d8aa28' },
      { name: 'MELON MELODY', color: '#f0ba8a' },
      { name: 'SYNTHETIC PUMPKIN', color: '#f67238' },
      { name: 'LIVID', color: '#6282c4' },
      { name: 'GEORGIA PEACH', color: '#f46a6b' },
      { name: 'RICHGARDENIA', color: '#f0784a' },
    ],
  },
];
